    ...
    children: [
      {
        ...
        name: 'Documentation',
        meta: { title: '我的项目', icon: 'user', affix: true }
      }
    ]
  },
  {
    path: '/Design_variable',
    component: Layout,
    children: [
      {
        path: 'index',
        component: () => import('@/views/app/Design_variable'),
        name: 'Documentation',
        meta: { title: '设计变量', icon: 'documentation', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Documentation',
        meta: { title: '设计不确定性', icon: 'el-icon-s-help', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Documentation',
        meta: { title: 'LCA方法不确定性', icon: 'list', affix: true }
      }
    ]
  },
  {
